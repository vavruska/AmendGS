...
static void add_exclude (pattern)
     char const *pattern;
{
...
static int add_exclude_file (name)
     char const *name;
{
  struct file_data f;
  char *p, *q, *lim;
...
static void add_regexp (reglist, pattern)
...
static int specify_format (var, value)
     char **var;
     char *value;
{
...
static void specify_style (style)
